...
##
## Date create/updated: 2023-02-20
##
...
# STILL NEED - have contacted authors 
...
# kinda dicey and minimally explained transformation in this paper - check with Freund for specifics.
# but these shouldn't really be included as they are more or less just the same data as the NCT and NWP recons
...
#Liu 2017 not included in Freund analysis
...
ggplot() +
  ...
  labs(title = "ENSO & PWC reconstructions aligned") +
  coord_flip(clip = "off") +
  scale_y_reverse() +
  scale_colour_identity() +
  theme_void() +
  theme(plot.margin = margin(t = 5, r = 250, b = 5, l = 5),
        axis.text = element_blank(),
        axis.title = element_blank())

# it makes no difference whether the 'transformed' Freund recons are included or not
